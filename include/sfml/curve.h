...
inline void Curve::setLimit(unsigned int limit) { limit_ = limit; }

inline void Curve::setThickness(float thickness) { thickness_ = thickness; }

inline void Curve::setFill(bool fill) { fill_ = fill; }

inline void Curve::setLabel(const std::string &label) { label_ = label; }
