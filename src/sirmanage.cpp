...
std::string sirmanage::get_modeltype() const
{
  return modeltype;
}
...
std::string sirmanage::get_in_filepath() const
{
  return in_filepath;
}
...
std::string sirmanage::get_out_filepath() const
{
  return out_filepath;
}
...
char sirmanage::get_output_type() const
{
  return output_type;
}
